...
def playermove(now_state,now_actions):
	while 1:
		a=input("Please enter the position: ")
		if a in now_actions:
...
def printchecker(now_state):
	print(" "+str(now_state[1])+" | "+str(now_state[2])+" | "+str(now_state[3])+" ")
	print("-----------")
	print(" "+str(now_state[4])+" | "+str(now_state[5])+" | "+str(now_state[6])+" ")
	print("-----------")
	print(" "+str(now_state[7])+" | "+str(now_state[8])+" | "+str(now_state[9])+" ")
...
def computermove(now_state,now_actions):
		action=minimax_decision2(now_state,now_actions)
		a=action
		now_actions.remove(a)
...
while 1:
	select=input("Please select your pieces: ")
